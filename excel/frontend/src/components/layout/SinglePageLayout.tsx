...
export default function SinglePageLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background" id="app-root">
      ...
      {/* Navbar with smooth scroll anchors for home, regular routing for other pages */}
      <SinglePageNavbar onSearchOpen={() => setSearchOpen(true)} />

      <main id="main-content" className="flex-1" tabIndex={-1}>
        <Outlet />
      </main>

      {/* Only show footer on home page (single page), feedback/404 have their own */}
      {isHomePage && <Footer />}
