  ...
  return (
    <div className="section-padding">
      <div className="container-gov max-w-4xl">
        <AnimatedHeading as="h1" className="text-center mb-8">{t.faq.title}</AnimatedHeading>
          ...
          <div className="space-y-3">
            {filtered.map((faq, i) => {
              ...
              return (
                ...
                >
                  <button
                    className="w-full flex items-center justify-between gap-4 p-5 text-left hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors"
